...
(async () => {
    try {
        ...
        const contractName = 'Idhawo'; // Change this for other contract
        const contract_address = '0x3d4DD75c8710903F2a486Ec2A5297122575c3273';
        ...
        const ids = getTokenIds(1, 7);
        const amounts = getAmounts(7);
